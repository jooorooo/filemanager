<div class="row fill">
    ...
    <div class="col-md-4 fill">
        <div class="text-center">
            ...
            <br>
            <button class="btn btn-primary" onclick="performCrop()">{!! Lang::get('filemanager::sfm.crop') !!}</button>
            <button class="btn btn-info" onclick="loadImages()">{!! Lang::get('filemanager::sfm.cancel') !!}</button>
            {!! Form::open(array('route' => 'filemanager.crop', 'role' => 'form', 'name' => 'cropForm',
...
<script>
    ...
    function performCrop() {
        $.ajax({
            type: "GET",
            dataType: "text",
            url: "{{ route('filemanager.cropimage') }}",
            data: {
                img: $("#img").val(),
                dir: $("#dir").val(),
                dataX: $("#dataX").val(),
